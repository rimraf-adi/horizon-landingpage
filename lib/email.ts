...
export async function sendAnalysisEmail(to: string, analysis: string, stats: Record<string, any>) {
  ...
  const html = `
    <div style="font-family:'Segoe UI',system-ui,sans-serif;max-width:600px;margin:0 auto;padding:0">
            ...
            <table style="width:100%">
              <tr>
                <td>
                  ...
                  <div style="font-size:12px;color:#4B5563;margin-top:2px">Your Trade Health Check report is ready.</div>
                </td>
      ...
      <p style="color:#6B7280;font-size:11px;margin-top:24px;text-align:center">Generated by Prop Trading Cockpit Trade Health Check</p>
    </div>
  `;

  await transporter.sendMail({
    from: `"Prop Trading Cockpit Trade Check" <${process.env.SMTP_USER}>`,
    to,
    subject: 'Your Trade Health Check Report — Prop Trading Cockpit',
    html,
  });
}
